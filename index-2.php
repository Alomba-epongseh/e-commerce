...
<body>
                        ...
                        <div class="header-top-left">
                            <div
                                ...
                                <a href="tel:0123456789" class="icon-space-right"><i
                                        class="icon-call-in"></i>+237676723201</a>
                                <a href="mailto:demo@example.com" class="icon-space-right"><i
                                        class="icon-envelope"></i>alombangwingche@gmail.com</a>
                            </div>
                        </div>
    ...
    <div id="search" class="search-modal">
        ...
        <form>
            ...
            <a href="search.php" ><button type="submit" name="search" class="btn btn-lg btn-golden">Search</button></a>
        </form>
    </div>
