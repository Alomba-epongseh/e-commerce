			...
			<div class="shop-products">
				...
				<div class="col-lg-6 col-md-6 col-sm-6 animated fadeInDown">
					<form  action="proedit.php" method="post" id="proformpanels" name="theform" enctype="multipart/form-data">
						...
						<?php if ($numrow > 1) {?>
	                        <div class="form-group row" style="margin-bottom: 0px; text-align: left;">
								...
								<div class="form-group col-sm-6" style="text-align: left; margin-bottom: 1px;">
									<div class="input-group">
										<div class="input-group-addon">$</div>
	                                    <input style="width:100%;" class="form-control" type="number" name="vprice[]"/>
						...
						<br/>
						<div class="form-group has-feedback" style="text-align: left;">
							<label for="purpose"> Short Description </label> 
							<p href="" data-toggle="tooltip" data-placement="top" title="Please enter purpose .">
								<textarea class="form-control ckeditor" wrap="soft" rows="10" name="purpose" id="purpose" placeholder="Please include any other specifications we have to pay attention to." value="" ><?php echo $rowItem['purpose']; ?></textarea>
							</p>
						</div>
						...
						<div class="form-group has-feedback" style="text-align: left;">
							...
							<p href="" data-toggle="tooltip" data-placement="top" title="Please enter Description .">
								<textarea class="form-control ckeditor" wrap="soft" rows="10" name="description" id="description" placeholder="Please include any other specifications we have to pay attention to." value="" ><?php echo $rowItem['description']; ?></textarea>
							</p>
						</div>
						...
						<div class="form-group">
							...
							<input class="form-control" type="file"  name="photo[]" value="" accept="image/*" style="width:100%; height:50px; padding:10px 10px; margin-bottom: 5px; background-color: #298042; color:#fff;"/>
