...
<body>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="account_form register" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <form action="#" method="post" enctype="multipart/form-data">
                            ...
                            <div class="login_submit">
                                <button class="btn btn-md btn-black-default-hover"  type="submit" name="insert_post">Register</button>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    <!-- ...:::: php code to collect user registration input and submit to db :::... -->
    <?php
    ...
    if (isset($_POST['insert_post'])) {
        ...
        $registerquery = "INSERT INTO register (email, username, pasword) VALUES ('$Email','$Username','$Password')";
        $result = mysqli_query($conn, $registerquery);


        if($result){
            echo "<script>alert('Accout Successfully Created')</script>";
